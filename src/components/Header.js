...
const Header = ({ handleClick, navbar, placeName }) => {
    ...
    return(
        <header className={navbar ? "_76q0O WJj7x" : "_76q0O"}>
            <div className="global-nav">
                <div className="_1EuBh">
                    <Link to="/" className="d9y3g" title="Food">
                    ...
                    <ul className="_1JNGZ">
                        ...
                        <li className="_1fo6c">
                            <div className="_2CgXb">
                                ...
                                {isAuthenticated ?
                                    (<span onClick={() => logout({ logoutParams: { returnTo: window.location.origin } })}>{user.name}</span>)
