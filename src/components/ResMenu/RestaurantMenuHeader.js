...
const RestaurantMenuHeader = (props) => {
    ...
    const { info, clickSearch, header } = props;

    const { name, sla } = info?.info;

    return(
        <div className={header ? "MenuTopHeader_menuContainer MenuTopHeader_menuContainerOnScroll" : "MenuTopHeader_menuContainer"}>
            <div className="MenuTopHeader_content">
                <div className="MenuTopHeader_contentTitle">{name}</div>
                <div className="MenuTopHeader_contentDescription">{sla.slaString}</div>
            </div>
            <div className="MenuTopHeader_rightNav">
                <div className="MenuTopHeader_rightNavItem" onClick={() => clickSearch()}>
