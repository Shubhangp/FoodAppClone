                    ...
                    <div className="styles_container">
                        <div className="styles_item">
                            <div className="styles_detailsContainer">
                                <div>
                                    <span className="res_card_img">
                                        {itemAttribute.vegClassifier == "NONVEG" ? (<img src={nonveg}/>) : (<img src={vege}/>)}
                                    </span>
                                ...
                                <div className="styles_itemName">
                                    <h3 className="styles_itemNameText">
                                        {name}
                                    </h3>
                                </div>
                                <div className="styles_itemPortionContainer">
                                    <span className="styles_price"><span className="rupee">
...
export default RestaurentSearchMap;