                                    ...
                                    <div className="styles_itemImageContainer__3Czsd">
                                        <div>
                                            <button className="styles_itemImage__3CsDL" aria-label="See more information about Biryani">
                                                <img alt="Biryani" className="styles_itemImage__3CsDL" loading="lazy" width="256" src={`https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_208,h_208,c_fit/${card?.card?.card?.info?.imageId}`} />
                                            </button>
                                        </div>
